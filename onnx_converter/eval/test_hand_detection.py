...
class NanodetPostProcess(object):
    ...
    def __call__(self, outputs, trans):
        ...
        out = post_process(preds, ResizeM, input_shape, raw_shape, self.strides, self.num_candidate,
                           self.prob_threshold, self.iou_threshold, self.agnostic_nms, self.num_classes,
                           self.reg_max)
        out = np.array(out[0])
        if len(out) == 0:
            return None
...
def parse_args():
    ...
    parser.add_argument('--model_path', type=str,
                        ...
                        default='work_dir/hand_detection_weight/nanodet_plus_320_320_simplify_qat_260.onnx',
    ...
    parser.add_argument('--results_path', type=str, 
                        default='./work_dir/tmpfiles/hand_results',
                        )
    ...
    parser.add_argument('--num_candidate', type=int, default=100)
    ...
    parser.add_argument(
        ...
        type=str, 
        # default="work_dir/qat/test_hand_detection_sosk/calibration_10.json",
        default=None,
    )       
