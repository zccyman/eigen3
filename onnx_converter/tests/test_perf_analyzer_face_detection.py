...
try:
    ...
    from onnx_converter.eval import Eval
...
def parse_args():
    ...
    parser.add_argument('--model_path', type=str,
                        ...
                        default='/home/ts300026/workspace/trained_models/face-detection/slim_special_Final_simplify_removed_pad.onnx',
...
if __name__ == '__main__':
    ...
    perf_estimator = PerfAnalyzer(model_exporter = myClsEval.process.model_export, chip_model=args.chip_model, \
