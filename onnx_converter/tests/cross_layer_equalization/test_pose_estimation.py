...
try:
    ...
    from onnx_converter.eval.coco_eval import CocoEval, overlay_bbox_cv
...
class CocoEvalWeightOpt(CocoEval):
    ...
    def __call__(self, quan_dataset_path=None):
        if self.weight_optimization in ["cross_layer_equalization"]:
            ...
            eval("self.process_wo." + self.weight_optimization)(quan_dataset_path, skip_layer_names=[])
...
def parse_args():
    ...
    parser.add_argument('--model_path', type=str,
                        default='/home/shiqing/Downloads/onnx-converter/trained_models/pose-estimation/yolov5n_v5.0_640_v2_simplify.onnx',
    ...
    parser.add_argument('--ann_path', type=str, 
                        ...
                        default='coco_kps_data/keypoint.json',
                        help='eval anno path')
    parser.add_argument('--dataset_path', type=str, 
                        # default='/buffer/coco/person_yolo/val/images',
                        default='coco_kps_data/images',
    ...
    parser.add_argument('--prob_threshold', type=float, default=0.001) #origin: 0.3, new: 0.3
